...
INSERT INTO DEPARTMENT(DEPT_NO, DEPT_NAME, FLOOR) VALUES(1, '영업', 1);
...
INSERT INTO EMPLOYEE(EMP_NO, EMP_NAME, TNO, MANAGER, SALARY, DNO, EMAIL, PASSWD) VALUES(1000, '윤원주', 5, 3011, 1500000, 4, 'test7@test.co.kr', '1234');
INSERT INTO EMPLOYEE(EMP_NO, EMP_NAME, TNO, MANAGER, SALARY, DNO, EMAIL, PASSWD) VALUES(1002, 'N영업1', 5, 4377, 2500000, 1, 'test8@test.co.kr', '1234');
INSERT INTO EMPLOYEE(EMP_NO, EMP_NAME, TNO, MANAGER, SALARY, DNO, EMAIL, PASSWD) VALUES(1004, 'N개발3', 4, 4377, 2500000, 3, 'test10@test.co.kr', '1234');
INSERT INTO EMPLOYEE(EMP_NO, EMP_NAME, TNO, MANAGER, SALARY, DNO, EMAIL, PASSWD) VALUES(1005, 'N기획2', 4, 4377, 2500000, 2, 'test9@test.co.kr', '1234');
INSERT INTO EMPLOYEE(EMP_NO, EMP_NAME, TNO, MANAGER, SALARY, DNO, EMAIL, PASSWD) VALUES(1006, 'N총무4', 3, 4377, 2500000, 4, 'test10@test.co.kr', '1234');

UPDATE EMPLOYEE SET TEL = '010-5438-8445' WHERE EMP_NO = 3011;
